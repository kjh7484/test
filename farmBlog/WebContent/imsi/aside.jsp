...
<aside>
	...
	<img src="/images/guest.png" onclick="location.href='login.do'" style="cursor:pointer;" width="100" height="100" 

class="homemenu"/><br>
	<b>TechFarm</b>님 &nbsp;&nbsp;<input type="button" value="로그아웃" style="width:70px;height:25px;"><br>
	<!-- 블로그가 있으면 -->
